    ...
    <main className="min-h-screen bg-stone-50">
      ...
      <section className="px-4 sm:px-6 pt-12 sm:pt-20 pb-12 sm:pb-16">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h1 className="mt-4 text-3xl sm:text-5xl lg:text-6xl font-semibold leading-tight text-stone-900">
            Community amenity booking, simplified.
          </h1>
          <p className="mx-auto mt-4 sm:mt-6 max-w-xl text-base sm:text-lg leading-relaxed text-stone-500">
          ...
          <div className="mt-8 sm:mt-10 flex flex-wrap justify-center gap-3 sm:gap-4">
            <Link
              href="/sign-up"
              className="rounded-full bg-emerald-600 px-6 sm:px-7 py-3 sm:py-3.5 text-sm font-semibold text-white shadow-sm hover:bg-emerald-500"
            >
              Get started free
            </Link>
            <Link
              href="/sign-in"
              className="rounded-full border border-stone-300 px-6 sm:px-7 py-3 sm:py-3.5 text-sm font-semibold text-stone-700 hover:bg-white"
            >
              Sign in
            </Link>
          </div>
      ...
      <section className="border-t border-stone-200 bg-white px-4 sm:px-6 py-14 sm:py-20">
        <div className="mx-auto max-w-5xl">
          ...
          <h2 className="mt-3 text-center text-2xl sm:text-3xl font-semibold text-stone-900">
            Three steps to your next reservation
          </h2>

          <div className="mt-10 sm:mt-14 grid gap-8 sm:gap-10 sm:grid-cols-3">
            {[
              {
                step: '1',
                title: 'Browse & book',
      ...
      {/* Features */}
      <section className="border-t border-stone-200 px-4 sm:px-6 py-14 sm:py-20">
        <div className="mx-auto max-w-5xl">
          <p className="text-center text-sm font-semibold uppercase tracking-[0.24em] text-stone-400">
      ...
      {/* Footer */}
      <footer className="border-t border-stone-200 bg-white px-4 sm:px-6 py-8">
        <div className="mx-auto flex max-w-5xl flex-col sm:flex-row items-center justify-between gap-4 text-sm text-stone-400">
          <p>Neighbri</p>
