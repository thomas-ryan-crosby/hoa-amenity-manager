...
export async function GET(req: NextRequest) {
  ...
  const statuses: BookingStatus[] = isJanitorial
    ? ['CONFIRMED', 'COMPLETED', 'DISPUTE', 'IN_PROGRESS', 'CLOSED']
    : isAdmin
      ? ['INQUIRY_RECEIVED', 'AVAILABILITY_CHECKING', 'PENDING_APPROVAL', 'PAYMENT_PENDING', 'CONFIRMED', 'IN_PROGRESS', 'REMINDER_SENT', 'WAITLISTED', 'COMPLETED', 'CLOSED']
      : ['INQUIRY_RECEIVED', 'AVAILABILITY_CHECKING', 'PENDING_APPROVAL', 'PAYMENT_PENDING', 'CONFIRMED', 'REMINDER_SENT', 'WAITLISTED', 'COMPLETED', 'CLOSED']
