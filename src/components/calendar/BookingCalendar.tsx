            ...
            <FullCalendar
              ...
              eventDidMount={(info) => {
                ...
                for (const other of allHarnesses) {
                  ...
                  if (otherTop < myTop + myHeight && otherTop + otherHeight > myTop) {
                    overlapIndex++
                  }
                }
